...
export default function Admin() {
  const { authConfig, user } = useLoaderData<typeof loader>();
              ...
              <div className="border border-bolt-elements-borderColor rounded-md overflow-hidden">
                <table className="min-w-full divide-y divide-bolt-elements-borderColor">
                  <thead className="bg-bolt-elements-background-depth-3">
                    <tr>
                      <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-bolt-elements-textSecondary uppercase tracking-wider">
                        Domain
                      </th>
                      <th scope="col" className="px-6 py-3 text-right text-xs font-medium text-bolt-elements-textSecondary uppercase tracking-wider">
                        Actions
                      </th>
                    </tr>
                  </thead>
